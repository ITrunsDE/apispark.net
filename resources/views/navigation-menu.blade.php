<nav x-data="{ isOpen: false }" class="bg-sky-500" aria-label="Global">
    ...
    <div class="lg:hidden" id="mobile-menu">
        <div class="space-y-1 px-2 pb-3 pt-2">
            <a href="{{ route('dashboard') }}"
               class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-sky-400 hover:text-white">Dashboard</a>

            @can('use_jobs')
                <a href="{{ route('endpoint-job.index') }}"
                   class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-sky-400 hover:text-white">Jobs</a>
            @endcan

            @can('use_endpoint')
                <a href="{{ route('endpoint.index') }}"
                   class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-sky-400 hover:text-white">Endpoints</a>
            @endcan

            @can('use_repository')
                <a href="{{ route('repository.index') }}"
                   class="block rounded-md px-3 py-2 text-base font-medium text-white hover:bg-sky-400 hover:text-white">Repositories</a>
            @endcan
        </div>
        <div class="border-t border-sky-500 pb-3 pt-4">
            ...
            <div class="mt-3 px-2">
                <a href="{{ route('profile.show') }}"
                   class="block rounded-md px-3 py-2 text-base font-medium text-sky-200 hover:bg-sky-400 hover:text-white">Your
                    Profile</a>
                ...
                <form method="POST" action="{{ route('logout') }}" x-data>
                    @csrf
                    <button type="submit"
                            class="block rounded-md px-3 py-2 text-base font-medium text-sky-200 hover:bg-sky-400 hover:text-white">
                        Sign out
                    </button>
                </form>
            </div>
