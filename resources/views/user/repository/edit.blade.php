    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 mt-6">
        ...
        <x-basic-card>
            ...
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Delete Repository</h1>
                    </div>
                </div>
                    ...
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600">
                                If you want to delete the repository. To confirm, please enter the name of the repository in the text field and confirm the whole thing.
                            </p>
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-2">
                                    <label for="name_confirmation"
                                           class="block text-sm font-medium leading-6 text-gray-900">Confirmation name</label>
                                    <div class="mt-2">
                                        <input type="text" name="name_confirmation" id="name_confirmation" autocomplete="name_confirmation"
                                               class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                                    </div>
                                </div>
                            </div>
