    ...
    <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 mt-6">
        ...
        <x-basic-card>
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">Verify Repository</h1>
                    </div>
                </div>
                            ...
                            <div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                                <div class="sm:col-span-2">
                                    <label for="verification_token"
                                           class="block text-sm font-medium leading-6 text-gray-900">Verification token</label>
                                    <div class="mt-2">
