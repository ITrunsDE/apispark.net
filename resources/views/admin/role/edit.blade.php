            ...
            <div class="px-4 sm:px-6 lg:px-8">
                ...
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900 dark:text-white">Role</h1>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.role.update', $role) }}">
                    ...
                    <div class="space-y-12">
                        <div class="border-b border-gray-900/10 dark:border-gray-100 pb-12">
                            ...
                            <p class="mt-1 text-sm leading-6 text-gray-600 dark:text-gray-200">
                                Fill out the required information edit the role.
                            </p>
                            ...
                            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3">
                                ...
                                <div class="sm:col-span-2">
                                    <label for="max_jobs" class="block text-sm font-medium leading-6 text-gray-900 dark:text-white">
                                        Max jobs
                                    </label>
                                    <div class="mt-2">
                    ...
                    <div class="mt-6 flex items-center justify-end gap-x-6">
                        <a href="{{ route('admin.role.index') }}" class="text-sm font-semibold leading-6 text-gray-900 dark:text-white">Cancel</a>
                        <button type="submit"
